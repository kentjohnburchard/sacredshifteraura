...
const Header: React.FC<HeaderProps> = ({ isUserMode = false, onToggleMode }) => {
  const { user } = useAuth();

  return (
    <header className="bg-gradient-to-r from-slate-900 via-purple-900/50 to-slate-900 border-b border-purple-500/20">
